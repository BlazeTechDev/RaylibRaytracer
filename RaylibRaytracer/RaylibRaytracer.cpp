...
int main()
{
	...
	TracingEngine::Initialize(Vector2(2048, 1024), 5, 5, 0.0005f);
	...
	RaytracingMaterial red2 = { Vector4(1,0,0,0), Vector4(0,0,0,0), Vector4(0,0,0,0) };
